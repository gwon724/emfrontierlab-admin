          ...
          <div className="bg-white rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="sticky top-0 bg-gradient-to-r from-gray-800 to-gray-900 p-6 rounded-t-2xl z-10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-white">AI 분석 보고서</h2>
                    <p className="text-sm text-indigo-100 mt-1">
                      {selectedClient && `${selectedClient.name}님의 종합 신용 및 정책자금 분석`}
                    </p>
                  </div>
                </div>
                <button
                  onClick={() => setShowReportModal(false)}
                  className="text-white hover:text-indigo-200 text-3xl font-bold"
                >
                  ×
                </button>
              </div>
            ...
            {loadingReport && (
              <div className="p-12 text-center">
                ...
                <p className="text-gray-600 text-lg">AI가 분석 보고서를 생성하고 있습니다...</p>
            ...
            {!loadingReport && reportData && (
              <div className="p-6 space-y-6">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-6 border-2 border-indigo-200">
                  ...
                  <p className="text-gray-700 leading-relaxed bg-white rounded-lg p-4">
                ...
                <div className="text-center text-xs text-gray-500 pt-4 border-t">
                  <p>보고서 생성 시간: {new Date(reportData.generatedAt).toLocaleString('ko-KR')}</p>
                  <p className="mt-1">이 보고서는 AI 기반 분석이며, 참고용으로만 사용하시기 바랍니다.</p>
                </div>
              </div>
            )}
